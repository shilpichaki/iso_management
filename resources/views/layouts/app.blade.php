                ...
                <ul class="metismenu" id="menu1">
                    <li class="active">
                        <a class="has-arrow" href="#">
                            <!--Customer Related Menu-->
                            <i class="fa big-icon fa-home icon-wrap"></i>
                            <span class="mini-click-non">Customer</span>
                        </a>
                        <ul class="submenu-angle" aria-expanded="true">
                            <li><a title="Customer List" href="{{ route('customer.index') }}"><i class="fa fa-bullseye sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">List of all customers</span></a></li>
                             <li><a title="Add Customer" href="{{ route('customer.create') }}"><i class="fa fa-circle-o sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Add New Customer</span></a></li>
                    ...
                    <li id="removable">
                        <a class="has-arrow" href="#" aria-expanded="false"><i class="fa big-icon fa-files-o icon-wrap"></i> <span class="mini-click-non">ISO Services</span></a>
                        <ul class="submenu-angle" aria-expanded="false">
                            <li><a title="ISO Service List" href="{{ route('products.index') }}"><i class="fa fa-hand-rock-o sub-icon-mg" aria-hidden="true"></i><span class="mini-sub-pro">Show All Services</span></a></li>
                            <li><a title="Add New Service" href="{{ route('products.create') }}"><i class="fa fa-plane sub-icon-mg" aria-hidden="true"></i><span class="mini-sub-pro">Add New Services</span></a></li>
                        </ul>
                    </li>

                    <li id="removable">
                        <a class="has-arrow" href="#" aria-expanded="false"><i class="fa big-icon fa-files-o icon-wrap"></i> <span class="mini-click-non">Certificaton Body Info</span></a>
                        <ul class="submenu-angle" aria-expanded="false">
                            <li><a title="ISO Service List" href="{{ route('products.index') }}"><i class="fa fa-hand-rock-o sub-icon-mg" aria-hidden="true"></i><span class="mini-sub-pro">Show All Body</span></a></li>
                            <li><a title="Add New Service" href="{{ route('products.create') }}"><i class="fa fa-plane sub-icon-mg" aria-hidden="true"></i><span class="mini-sub-pro">Add New Body</span></a></li>
                        </ul>
                    </li>
